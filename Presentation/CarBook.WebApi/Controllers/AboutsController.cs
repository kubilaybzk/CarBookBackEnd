using CarBookBackEnd.Application.Features.CQRS.Commands.AboutCommands;
...
namespace CarBook.WebApi.Controllers
{
    ...
    public class AboutsController : ControllerBase
    {
        ...
        [HttpGet("GetAbouthList")]
        public async Task<IActionResult> GetAbouthList()
        {
            var values = await _getAboutQueryHandler.Handle();
            return Ok(values);
        }

        [HttpGet("GetAboutBy/{id}")]
        public async Task<IActionResult> GetAboutBy(int id)
        {
